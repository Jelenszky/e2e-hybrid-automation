...
/**
 * API test data structure - flattened format with snake_case field names
 * Generated by UserDataFactory.toApiFormat() for API test requests
 */
export interface ApiTestUserData {
  name: string;
  email: string;
  password: string;
  title: string;
