...
apiTest.describe('User Account API', () => {
  apiTest.describe('POST Create/Register User Account', () => {
    ...
    apiTest('should fail to create user with existing email', async ({ userService }) => {
      const userData = UserDataFactory.generateApiTestUserData();
    ...
    apiTest('should fail to create user with invalid email format', async ({ userService }) => {
      const userData = UserDataFactory.generateApiTestUserData();
  ...
  apiTest.describe('DELETE User Account', () => {
    apiTest('should delete existing user account', async ({ userService }) => {
      const userData = UserDataFactory.generateApiTestUserData();
    ...
    apiTest('should fail to delete with invalid credentials', async ({ userService }) => {
    ...
    apiTest('should fail to delete with missing password', async ({ userService }) => {
      const userData = UserDataFactory.generateApiTestUserData();
    ...
    apiTest(
      'should fail to delete with correct email but wrong password',
      async ({ userService }) => {
        const userData = UserDataFactory.generateApiTestUserData();
  ...
  apiTest.describe('PUT Update User Account', () => {
    apiTest('should update existing user account', async ({ userService }) => {
      const userData = UserDataFactory.generateApiTestUserData();
    ...
    apiTest('should fail to update non-existent account', async ({ userService }) => {
      const { nonexistentEmail, invalidPassword } = UserDataFactory.generateInvalidCredentials();
      const userData = UserDataFactory.generateApiTestUserData();
  ...
  apiTest.describe('GET User Account Detail by Email', () => {
    apiTest(
      'should get user details by email with all fields matching creation data',
      async ({ userService }) => {
        const userData = UserDataFactory.generateApiTestUserData();
    ...
    apiTest('should fail to get details for non-existent email', async ({ userService }) => {
  ...
  apiTest.describe('GET User Account - Schema Validation', () => {
